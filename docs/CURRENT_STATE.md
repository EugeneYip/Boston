...
| Budgets | Draws peak **1054** of 1200. Camera triangles **2.53M** of 3.5M. **The one remaining breach is shadow triangles at 2.73–3.47M against 2.5M** — anything that adds shadow-casting geometry must report its delta. |
