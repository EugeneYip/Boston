/**
 * Stage 2A.4 — pixel diff, against an A/A floor.
 *
 *   node research/gis-stage2a4/capture-diff.mjs
 *
...
writeFileSync(new URL('./capture-diff.json', import.meta.url), JSON.stringify(
  { schemaVersion: 'boston-gis-stage2a4/capture-diff/0.1.0', canvas: [1280, 720],
